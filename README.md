...
The guided sequence, per-shot qualification reason, sample identity, invalidated partial sequences, and protocol policy are preserved in schema-4 campaign evidence. A dedicated protocol result document remains separate development work.
